...
const goalSchema = mongoose.Schema(   //think of schemas or models as the layout structure of your collection/table, where you define what fields/columns/attributes you want in your table, and each document/entry will have those fields.
    {
        userId: {
            type: mongoose.Schema.Types.ObjectId,   //we linked or related the Goal collection/table to the User collection/table by adding the userId attribute to the Goal schema. The userId attribute references from the User schema.
            required: true,
            ref: "User"
        },
        text: {
